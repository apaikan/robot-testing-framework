...
#ifndef ROBOTTESTINGFRAMEWORK_JSONOutputter_H
#define ROBOTTESTINGFRAMEWORK_JSONOutputter_H
...
/**
 * \brief Class JSONOutputter saves the results of the test collected by
 * a TestResultCollector in a JSON file.
 */
class JSONOutputter
{
public:
    /**
     * @brief JSONOutputter constructor.
     * @param collector an instance of a TestResultCollector which holds
     * the results of the test
     * @param verbose enables the verbose mode. If true, the source file and
     ...
     */
    JSONOutputter(TestResultCollector& collector,
                   bool verbose = false);

    /**
     * @brief ~JSONOutputter destructor
     */
    virtual ~JSONOutputter();

    /**
     * @brief write Write the results of the test in a JSON file.
...
#endif // ROBOTTESTINGFRAMEWORK_JSONOutputter_H
